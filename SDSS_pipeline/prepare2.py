...
def call_SE(fitsFile):
    ...
    if subprocess.call("which sex >/dev/null", shell=True) == 0:
        ...
        exit(1)
    callString += "-c /home/amosenko/programs/Sergey/pipeline-master/pipelinelib/default.sex"
...
if __name__ == "__main__":
    ...
    for band in bandList:
        ...
        estimate_sky(inFile, outFile, degree=1)
        add_header(['GAIN','M0'],inFile,outFile) # Add keywords
        #os.remove("segm.fits")
        #os.remove("field.cat")
	...
	add_header(['GAIN','M0'],fitsName,outFitsName) # Add keywords
