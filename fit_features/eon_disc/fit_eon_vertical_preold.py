...
def fit_each_vert_slice(image_data, mask_data, sigma_data, psf_image, x_min_ind, x_max_ind,  y_min_ind_dn, y_max_ind_dn, y_min_ind_up, y_max_ind_up, ron, gain, n_fixed='fixed', L0=None, N=None, z0=None, y0=None, L02=None, N2=None, z02=None, L03=None, N3=None, z03=None,  disc_comps = 'single'):
    ...
    elif disc_comps=='double' or disc_comps=='tripple':
        '''
...
def do_each_bin_x(R, image_data, sigma_data, mask_data, psf_image, x_min_ind, x_max_ind, y_min_ind_dn, y_max_ind_dn, y_min_ind_up, y_max_ind_up, disc_comps='single', error_est=True, ron=None, gain=None, n_fixed='fixed', side=1):
    ...
    if disc_comps=='double':
        # Double disc fit:
        L01,N1,Z01,L02,N2,Z02 = fit_each_vert_slice(image_data, mask_data, sigma_data, psf_image, x_min_ind, x_max_ind,  y_min_ind_dn, y_max_ind_dn, y_min_ind_up, y_max_ind_up, ron, gain, n_fixed, L0, N, Z0, Y0, disc_comps='double')
        ...
        if error_est:
            ...
            for k in slice_list:
                p1,p2,p3,p4,p5,p6 = fit_each_vert_slice(image_data, mask_data, sigma_data, psf_image, k, k+1,  y_min_ind_dn, y_max_ind_dn, y_min_ind_up, y_max_ind_up, ron, gain, n_fixed, L01, N1, Z01, Y0, L02, N2, Z02, disc_comps='double')
                #exit()
                L001.append(p1)
                NN1.append(p2)
                Z001.append(p3)
...
if __name__ == "__main__":    
    ...
    main(input_image, mask_image=mask_image, weight_image=weight_image, psf_image='psf.fits', R_in_l=R_in_l, R_out_l=R_out_l, R_in_r=R_in_r, R_out_r=R_out_r, z_in_dn = z_in_dn, z_out_dn=z_out_dn, z_in_up=z_in_up, z_out_up=z_out_up, bin_type='linear', n_fixed=n_fixed, side='1', error_est=False, disc_comps='single')
    shutil.move('vertical_fits_1.dat', 'vertical_fits_1_thick.dat')
    '''
    input_image = 'NGC891_coadd_rot_crop_aver.fits'
    mask_image = 'NGC891_coadd_mask_rot_crop_aver.fits'
    weight_image = 'NGC891_coadd_sigma_rot_crop_aver.fits'
    ...
    shutil.move('vertical_fits_1.dat', 'vertical_fits_1_superthin_thin.dat')
