...
def ellipse_mask(cen, ellA, ellB, ellPA, inframe, xSize, ySize, img_inp=None,img_mask=None, outer = False, mask_value=1):
                ...
                if True:
                    for line in f:
						  ...
						  float(line.split("(")[-1].split(",")[1]))
                                ...
                                ellB = ellA
                                ellPA = 0.
                                ellipse_mask(cen, ellA, ellB, ellPA, img3, dimx, dimy, img_mask=img2, mask_value=mask_value)
						  ...
						  float(params[1]))
                                ...
                                if 'text={outer}' in line:
                                    ...
                                    outer = False
                                ellipse_mask(cen, ellA, ellB, ellPA, img3, dimx, dimy, outer=outer, img_mask=img2, mask_value=mask_value)
                            coun = coun + 1
