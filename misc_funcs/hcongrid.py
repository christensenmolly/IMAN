...
#
def hcongrid(image, header1, header2, preserve_bad_pixels=False, no_interp=False, **kwargs):
    ...
    if no_interp==False:
        ...
        newimage = scipy.ndimage.map_coordinates(image, grid1, order=0, mode='constant')
...
def get_pixel_mapping(header1, header2):
    ...
    if convert_coordinates:
        ...
        try:
          ...
          lat2,lon2 = wcs2.wcs_pix2world(xx2, yy2, 0)
          C2 = coordinates.SkyCoord(lon2,lat2,unit=(u.deg,u.deg),frame=csys2)
