...
def main(input_image, mask_image, output_image='interpolated.fits', sigma_smooth=10., sampling_factor=None, sigma_back=None):
    ...
    new_data = make_interpolated_image(data, mask, X, Y)

    
    outHDU = pyfits.PrimaryHDU(new_data, header)
...
if __name__ == "__main__":
    ...
    main(input_image, mask_image, output_image=output_image, sigma_smooth=sigma_smooth, sampling_factor=factor, sigma_back=sigma_back)