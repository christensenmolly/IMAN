...
__alh__ = ['ks2d2s', 'estat', 'estat2d']

# Taken from https://github.com/syrte/ndtest/blob/master/ndtest.py
# See also https://stackoverflow.com/questions/29544277/python-2-d-kolmogorov-smirnov-with-2-samples
